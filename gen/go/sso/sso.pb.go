...
func (x *RegisterRequast) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterRequast) ProtoMessage() {}

func (x *RegisterRequast) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[0]
...
// Deprecated: Use RegisterRequast.ProtoReflect.Descriptor instead.
func (*RegisterRequast) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{0}
}

func (x *RegisterRequast) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *RegisterRequast) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *LoginRequast) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginRequast) ProtoMessage() {}

func (x *LoginRequast) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginRequast.ProtoReflect.Descriptor instead.
func (*LoginRequast) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{2}
}

func (x *LoginRequast) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *LoginRequast) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *LoginRequast) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *IsAdminRequast) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminRequast) ProtoMessage() {}

func (x *IsAdminRequast) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminRequast.ProtoReflect.Descriptor instead.
func (*IsAdminRequast) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{4}
}

func (x *IsAdminRequast) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x65, 0x71, 0x75, 0x61, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69,
	...
	0x52, 0x65, 0x71, 0x75, 0x61, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c,
	...
	0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x61, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	...
	0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x61, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x61,
	...
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x61, 0x73,
	...
	0x52, 0x65, 0x71, 0x75, 0x61, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49,
	0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x42, 0x19,
	0x5a, 0x17, 0x63, 0x6f, 0x66, 0x66, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x2e, 0x73, 0x73, 0x6f,
...
var file_sso_sso_proto_goTypes = []interface{}{
	(*RegisterRequast)(nil),  // 0: auth.RegisterRequast
	(*RegisterResponce)(nil), // 1: auth.RegisterResponce
	(*LoginRequast)(nil),     // 2: auth.LoginRequast
	(*LoginResponce)(nil),    // 3: auth.LoginResponce
	(*IsAdminRequast)(nil),   // 4: auth.IsAdminRequast
	(*IsAdminResponce)(nil),  // 5: auth.IsAdminResponce
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequast
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequast
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequast
